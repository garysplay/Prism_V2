...
namespace Prism
{
    public enum ThemePack // Define the enumeration for different theme packs
    {
        Light,
        Dark,
        Blue,
        HatsuneMiku // New: Hatsune Miku theme pack
    }

    // Moved outside PrismSettings class for global accessibility within the Prism namespace
    public enum SortColumn // Define the enumeration for sorting columns
    {
        Filename,
        Type,
        Size,
    ...
    // Moved outside PrismSettings class for global accessibility within the Prism namespace
    public enum SortOrder // Define the enumeration for sorting order
    {
        Ascending,
        Descending
    }
    ...
    public class PrismSettings
    {
        ...
        [
            Category("User Interface"), // New category for UI settings
            DisplayName("Theme Pack"),
            Description("Select the visual theme for the application."),
            DefaultValue(ThemePack.Dark) // Default to Dark theme
        ]
        public ThemePack ActiveThemePack { get; set; } = ThemePack.Dark;

        [
            Category("Asset List"), // New category for asset list settings
            DisplayName("Sort Column"),
            Description("The column by which the asset list should be sorted."),
            DefaultValue(SortColumn.Filename) // Default sort by filename
        ]
        public SortColumn ActiveSortColumn { get; set; } = SortColumn.Filename; // New property for sorting column

        [
            Category("Asset List"), // New category for asset list settings
            DisplayName("Sort Order"),
            Description("The order in which the asset list should be sorted."),
            DefaultValue(SortOrder.Ascending) // Default sort order ascending
        ]
        public SortOrder ActiveSortOrder { get; set; } = SortOrder.Ascending; // New property for sorting order
